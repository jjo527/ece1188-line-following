...
State_t fsm[9]= {
    {0x01,   &Motor_Forward  , 8000, 8000,  500, 20, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostGo}},  // S1 CENTER      red
    {0x02,   &Motor_Forward  , 6750, 8000,  500, 10, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostL}},   // S2 CLOSE_LEFT  green
    {0x03,   &Motor_Left     , 3000, 6000,  500, 0, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostL}},    // S3 FAR_LEFT    yellow
    {0x04,   &Motor_Forward  , 8000, 6750,  500, 10, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostR}},   // S4 CLOSE_RIGHT blue
    {0x05,   &Motor_Right    , 6000, 3000,  500, 0, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostR}},   // S5 FAR_RIGHT   pink
    {0x07,   &Motor_Left     , 4000, 8000, 1000, 0, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostL}},     // S6 LostL       white
    {0x07,   &Motor_Right    , 8000, 4000, 1000, 0, { FAR_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, FAR_RIGHT, LostR}},     // S7 LostR       white
