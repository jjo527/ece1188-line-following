...
#define MY_MULTIPLIER 3
#define MY_MULTIPLIER_BEND 2
#define BASE_SPEED 1000
#define SOFT_TURN 600
#define MID_TURN 300
#define HARD_BACK 1500
...
State_t fsm[11]= {
    ...
    {0x02,   &Motor_Forward  , SOFT_TURN * MY_MULTIPLIER, BASE_SPEED* MY_MULTIPLIER,  500, 10, { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostL}},      // S2 CLOSE_LEFT  green
    {0x03,   &Motor_Forward     , MID_TURN * MY_MULTIPLIER_BEND, BASE_SPEED * MY_MULTIPLIER_BEND,  500, 10, { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostL}},      // S2 MID_LEFT  green
    {0x04,   &Motor_Left     , HARD_BACK * MY_MULTIPLIER_BEND, BEND_SPEED * MY_MULTIPLIER_BEND,  500, 0,  { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostL}},      // S3 FAR_LEFT    yellow
    {0x02,   &Motor_Forward  , BASE_SPEED * MY_MULTIPLIER, BASE_SPEED * MY_MULTIPLIER,  500, 10, { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostR}},      // S4 CLOSE_RIGHT blue
    {0x03,   &Motor_Forward    , BASE_SPEED * MY_MULTIPLIER_BEND, MID_TURN * MY_MULTIPLIER_BEND,  500, 10, { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostR}},      // S4 CLOSE_RIGHT blue
    {0x04,   &Motor_Right    , BEND_SPEED * MY_MULTIPLIER_BEND, HARD_BACK * MY_MULTIPLIER_BEND,  500, 0,  { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostR}},      // S5 FAR_RIGHT   pink
    {0x07,   &Motor_Left , LOST_BACK * MY_MULTIPLIER_BEND, BASE_SPEED * MY_MULTIPLIER_BEND,1000, 0,  { FAR_LEFT, MID_LEFT, CLOSE_LEFT, CENTER, CLOSE_RIGHT, MID_RIGHT, FAR_RIGHT, LostL}},     // S6 LostL       white
